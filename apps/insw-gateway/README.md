...
Configure Railway's root directory as `apps/insw-gateway`; it can then auto-detect this component's `Dockerfile`.

1. Push repo to GitHub → **New Project** → **Deploy from GitHub repo** → set root directory `apps/insw-gateway`.
