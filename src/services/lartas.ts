...
export function createLartasService(h: HttpClient, t: TokenManager, c: Config) {
    async function proxyRequest(
        ...
        const baseUrl = c.lartasBaseUrl.replace(/\/+$/, '');
        ...
        const response = await h.request(url.toString(), fetchOptions);
